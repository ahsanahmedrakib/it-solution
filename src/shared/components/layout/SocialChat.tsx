...
export default function SocialChat() {
  ...
  return (
    <div className="fixed bottom-2 right-2 z-50 flex flex-col items-center gap-2">
      ...
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
          <path d="M12 2C6.477 2 2 6.145 2 11.243c0 2.837 1.394 5.377 3.583 7.034V22l3.404-1.868C10.138 20.47 11.053 20.6 12 20.6c5.523 0 10-4.145 10-9.357C22 6.145 17.523 2 12 2zm1.055 12.563l-2.53-2.716L5.5 14.563l5.173-5.49 2.628 2.716 4.972-2.716-5.218 5.49z" />
        </svg>
      </a>
    </div>
  );
